...
#     if(nhavepi == 1){
#         print(paste0('Totally ', 
#                     round(100*sum(outcome4[,niter]>99.99)/wgenes,3),
#                     '% genes estimated touch the optimization bound'))
#         }else{
#         print(paste0('Totally ', 
#                     round(100*sum(outcome4[,niter]>24.99)/wgenes,3),
#                     '% genes estimated touch the optimization bound'))
#         }
